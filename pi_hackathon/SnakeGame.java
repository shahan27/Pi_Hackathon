...
public class SnakeGame extends JFrame {
    ...
    //comment
    private static String piString = Double.toString(Math.PI);
    ...
    private TileType updateSnake() {
        ...
        for(int num=MIN_SNAKE_LENGTH + 1; num<snake.size(); num++) {
            switch(piString.charAt(num - MIN_SNAKE_LENGTH - 1)){ 
                case '1':
                board.setTile(snake.get(num), TileType.Snake1);
                break;
                
                case '2':
                board.setTile(snake.get(num), TileType.Snake2);
                break;
                
                case '3':
                board.setTile(snake.get(num), TileType.Snake3);
                break;
                
                case '4':
                board.setTile(snake.get(num), TileType.Snake4);
                break;
                
                case '5':
                board.setTile(snake.get(num), TileType.Snake5);
                break;
                
                case '6':
                board.setTile(snake.get(num), TileType.Snake6);
                break;
                
                case '7':
                board.setTile(snake.get(num), TileType.Snake7);
                break;
                
                case '8':
                board.setTile(snake.get(num), TileType.Snake8);
                break;
                
                case '9':
                board.setTile(snake.get(num), TileType.Snake9);
                break;
                
                case '.':
                board.setTile(snake.get(num), TileType.SnakeDot);
                break;
