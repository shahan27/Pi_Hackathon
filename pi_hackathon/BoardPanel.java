...
public class BoardPanel extends JPanel {
    ...
    private void drawTile(int x, int y, TileType type, Graphics g) {
        ...
        case Fruit:
            ...
            g.drawString(piString.charAt(this.game.getFruitsEaten())+ "", numX, numY);
            break;
    ...
    case SnakeDot:
        g.setColor(Color.GREEN);
        g.fillOval(x+10, y+10, TILE_SIZE-14, TILE_SIZE-14);
        break;
        
    case Snake1:
        g.setColor(Color.GREEN);
        g.drawString("1", numX, numY);
        break;
   ...
   case Snake3:
        g.setColor(Color.GREEN);
        g.drawString("3", numX, numY);
        break;
    case Snake4:
        g.setColor(Color.GREEN);
            g.drawString("4", numX, numY);
        break;
    case Snake5:
        g.setColor(Color.GREEN);
        g.drawString("5", numX, numY);
        break;
    case Snake6:
        g.setColor(Color.GREEN);
        g.drawString("6", numX, numY);
        break;
    case Snake7:
        g.setColor(Color.GREEN);
        g.drawString("7", numX, numY);
        break;
    case Snake8:
        g.setColor(Color.GREEN);
        g.drawString("8", numX, numY);
        break;
    case Snake9:
        g.setColor(Color.GREEN);
        g.drawString("9", numX, numY);
        break;
